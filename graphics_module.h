...
typedef vector_3d screen_vertex;
...
typedef screen_vertex (*projection_function)(vector_3d);

//function pointer that ...
typedef void (*draw_triangle_function)(pixel_buffer*, screen_vertex, screen_vertex, screen_vertex, uint32_t);
